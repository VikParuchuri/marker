...
class LayoutBuilder(BaseBuilder):
    ...
    def surya_ocr_error_detection(self, pages:List[PageGroup], provider_page_lines: ProviderPageLines) -> List[OCRErrorDetectionResult]:
        tokenizer = self.ocr_error_model.tokenizer
        page_texts = []
