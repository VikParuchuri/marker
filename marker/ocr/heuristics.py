...
def should_ocr_page(page: Page, no_text: bool, OCR_ALL_PAGES):
    ...
    return any(conditions) or settings.OCR_ALL_PAGES or OCR_ALL_PAGES
...
def detected_line_coverage(page: Page, intersect_thresh=0.5, detection_thresh=0.4):
    found_lines = 0
